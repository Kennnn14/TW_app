    ...
    <div class="navbar">
        <nav>
            ...
            <ul>
                ...
                <li class="top-li">
                    <a href="/index" class="{{ $title == 'index' ? 'active' : 'ac-2' }}">Home <i class="fa-solid fa-arrow-up mb-arrow"></i></a>
                </li>
                <li>
                ...
                <li>
                    <a href="/contact" class="contact {{ $title == 'contact' ? 'active' : 'ac-6' }}">Contact Us <i class="fa-solid fa-arrow-up mb-arrow"></i></a>
                </li>
                <li id="login-nav">
